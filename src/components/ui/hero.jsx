  ...
  (
    ...
    return (
      <section
        ref={ref}
        className={cn(
          "relative z-0 flex min-h-[80vh] mt-4 w-full flex-col items-center justify-center overflow-hidden rounded-md bg-background",
          className,
        )}
        {...props}
      >
        ...
        >
          <div className="flex flex-col items-center text-center space-y-4">
            <h1
              className={cn(
                "text-4xl sm:text-5xl md:text-6xl lg:text-7xl mt-14 lg:mt-0 md:lg-0 font-bold tracking-tight",
                titleClassName,
              )}
            >
              {title}
